...
local function processKissReply(cmd, rx_buf)
   ...
   if #(rx_buf) > 0 then
        ...
        uno = rx_buf[1]
        band = 1 + bit32.rshift(rx_buf[2], 3)
...
local function run(event)
  ...
  lcd.drawText(10,5, uno, 0)
        lcd.drawText(10,15, table[band], 0)
        lcd.drawText(10,25, channel, 0)
        lcd.drawText(10,35, minPw, 0)
        lcd.drawText(10,45, maxPw, 0)
